...
class MyFrame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, pos=wx.DefaultPosition, size=wx.Size(400, 100),
        ...
        lbl = wx.StaticText(panel, label="Hello Agent! How can I help you.(Press enter for speech input)")
    ...
    def OnEnter(self, event):
        ...
        if put == '':
            ...
            try:
                ...
                print("Unknown error occurred,while taking voive input!")
        ...
        if put.startswith('play '):
            ...
            try:
                jsonObj = urlopen(
                    '''  https://newsapi.org/v1/articles?source=al-jazeera-english&sortBy=latest&apiKey=571863193daf421082a8666fe4b666f3''')
            ...
            try:
                jsonObj = urlopen(
                    '''https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=571863193daf421082a8666fe4b666f3''')
                data = json.load(jsonObj)
                i += 1
            ...
            try:
                jsonObj = urlopen(
                    ''' https://newsapi.org/v1/articles?source=espn-cric-info&sortBy=latest&apiKey=571863193daf421082a8666fe4b666f3''')
                data = json.load(jsonObj)
                i += 1
            ...
            try:
                jsonObj = urlopen(
                    '''https://newsapi.org/v1/articles?source=the-hindu&sortBy=latest&apiKey=571863193daf421082a8666fe4b666f3''')
                data = json.load(jsonObj)
                i += 1
